...
var saveAs =
  ...
  (function (view) {
  	...
  	FS_proto.error = FS_proto.onwritestart = FS_proto.addEventListener('progress', FS_proto.onwrite = FS_proto.addEventListener('abort', FS_proto.addEventListener('error', FS_proto.onwriteend = null)));
